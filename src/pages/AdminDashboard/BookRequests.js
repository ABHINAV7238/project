...
function BookRequests() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/borrow')
            .then(response => {
    ...
    const handleAccept = (borrwID) => {
        axios.put('http://localhost:8080/api/borrow/accept', { borrowId: borrwID })
            .then(res => {
                toast.success("Request accepted");
                axios.get('http://localhost:8080/api/borrow/' + borrwID)
                    .then(res => {
                        ...
                        axios.get('http://localhost:8080/api/requests')
                            .then(response => {
                                ...
                                axios.put('http://localhost:8080/api/requests/' + requestId, {
    ...
    const handleReject = (borrwID) => {
        axios.put('http://localhost:8080/borrow/api/reject', { borrowId: borrwID })
            .then(res => {
